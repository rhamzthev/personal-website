import { getGithubRepos, getRepoReadme, getRepoLanguages } from '@/lib/github';
...
export async function generateMetadata({
    ...
    try {
        ...
        if (!repo) {
            return {
                title: 'Project Not Found | Portfolio | Rhamsez Thevenin',
                description: 'This project could not be found.'
            };
        }

        return {
            title: `${repo.name} | Portfolio | Rhamsez Thevenin`,
            description: repo.description || `Details about ${repo.name} project by Rhamsez Thevenin`
        };
    } catch {
        return {
            title: `${params.repoName} | Portfolio | Rhamsez Thevenin`,
            description: `Details about ${params.repoName} project by Rhamsez Thevenin`
        };
    }
}
...
export default async function RepoPage({ params }: { params: { repoName: string } }) {
    ...
    try {
        ...
        const processedReadmeHtml = readmeHtml ? processCodeBlocks(readmeHtml) : null;
